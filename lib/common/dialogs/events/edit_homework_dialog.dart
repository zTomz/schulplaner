...
import 'package:schulplaner/config/constants/model.dart';
...
class EditHomeworkDialog extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return weeklyScheduleData.when(
      data: (weeklyScheduleTuple) {
        final List<Lesson> lessons = weeklyScheduleTuple.$1;
        final List<Teacher> teachers = weeklyScheduleTuple.$3;
        final List<Subject> subjects = weeklyScheduleTuple.$4;
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      onPressed: subject.value != null && date.value != null
                          ? () async {
                              final result = await showDialog(
                                context: context,
                                builder: (context) =>
                    ...
                    if (response.text != null) {
                      ...
                      try {
                        processingDate = ProcessingDate.fromMap(
                          jsonDecode(response.text.toString())
